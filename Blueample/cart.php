    ...
    <body>
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="https://www.instamojo.com/@jerome_anto03/" class="btn btn-primary">payment</a></th>
                ...
                <a href="https://www.instamojo.com/@jerome_anto03/" rel="im-checkout" data-text="Pay" data-css-style="color:#ffffff; background:#75c26a; width:300px; border-radius:4px"   data-layout="vertical"></a>
            ...
            <footer class="footer">
               <div class="container">
                <center>
                   ...
                   <p>This website is developed by Jerome Anefar</p>
               </center>
               </div>
           </footer>
        </div>
